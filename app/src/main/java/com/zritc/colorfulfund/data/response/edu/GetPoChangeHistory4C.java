...
public class GetPoChangeHistory4C implements Serializable {
    ...
    public synchronized GetPoChangeHistory4C parseJson(String json) throws JSONException {
    	JSONObject jsonObject = new JSONObject(json);
	    	...
	    	if (jsonObjectPoFundList.isNull("fundInfo")) {
	    		Log.d("GetPoChangeHistory4C", "has no mapping for key " + "fundInfo" + " on " + new Throwable().getStackTrace()[0].getClassName() + ", line number " + new Throwable().getStackTrace()[0].getLineNumber());
	    	}
			
	    	JSONObject jsonObjectFundInfo = jsonObjectPoFundList.optJSONObject("fundInfo");
			...
			fundInfo.poPercentage = jsonObjectFundInfo            .optString("poPercentage");
	    		
	    		poFundList.fundInfo = fundInfo;
