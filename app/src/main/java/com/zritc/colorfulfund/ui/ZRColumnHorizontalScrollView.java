...
public class ZRColumnHorizontalScrollView extends HorizontalScrollView {
	/** 传入整体布局 */
	...
	public ZRColumnHorizontalScrollView(Context context) {
		super(context);
	}

	public ZRColumnHorizontalScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
