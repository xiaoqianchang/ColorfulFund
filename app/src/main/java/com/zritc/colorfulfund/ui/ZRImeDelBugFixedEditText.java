 ...
 * Overflow</a>
 */
public class ZRImeDelBugFixedEditText extends EditText {

    private OnDelKeyEventListener delKeyEventListener;

    public ZRImeDelBugFixedEditText(Context context) {
        super(context);
    }

    public ZRImeDelBugFixedEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ZRImeDelBugFixedEditText(Context context, AttributeSet attrs, int defStyle) {
