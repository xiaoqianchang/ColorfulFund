...
public class ZRQuickAlphabeticBar extends ImageButton {
	...
	public ZRQuickAlphabeticBar(Context context) {
		super(context);
	}

	public ZRQuickAlphabeticBar(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public void init(Activity ctx) {
		int id = ZRResourceManager.getResourceID("fast_position", "id");
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < letters.length; i++) {
			paint.setColor(Color.parseColor("#faa701"));
			paint.setTextSize(38.f);
