 ...
 */
public class ZRHeaderLoadingLayout extends ZRLoadingLayout {
	/** 旋转动画时间 */
	 ...
	 *            context
	 */
	public ZRHeaderLoadingLayout(Context context) {
		super(context);
		init(context);
	}
	 ...
	 *            attrs
	 */
	public ZRHeaderLoadingLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		mProgressBar = (ProgressBar) findViewById(ZRResourceManager
				.getResourceID("pull_to_refresh_header_progressbar", "id"));
	...
	protected void onPullToRefresh() {
		if (ZRILoadingLayout.State.RELEASE_TO_REFRESH == getPreState()) {
			mArrowImageView.clearAnimation();
