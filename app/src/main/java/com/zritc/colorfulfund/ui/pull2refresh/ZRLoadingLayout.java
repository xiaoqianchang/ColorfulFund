 ...
 */
public abstract class ZRLoadingLayout extends FrameLayout implements
        ZRILoadingLayout {
     ...
     */
    public ZRLoadingLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs attrs
     */
    public ZRLoadingLayout(Context context, AttributeSet attrs) {
     ...
     */
    public ZRLoadingLayout(Context context, AttributeSet attrs, int defStyle) {
