 ...
 */
public class ZRPullToRefreshGridView extends ZRPullToRefreshBase<GridView>
		implements OnScrollListener {

	/** ListView */
	private GridView mGridView;
	/** 用于滑到底部自动加载的Footer */
	private ZRLoadingLayout mFooterLayout;
	/** 滚动的监听器 */
	 ...
	 *            context
	 */
	public ZRPullToRefreshGridView(Context context) {
		this(context, null);
	}
	 ...
	 *            attrs
	 */
	public ZRPullToRefreshGridView(Context context, AttributeSet attrs) {
	...
	protected GridView createRefreshableView(Context context, AttributeSet attrs) {
		...
		// mGridView.setSelector(ZRResourceManager.getResourceID("transparent",
		// "color"));
	...
	public void setSpacing(int hSpace, int vSpace) {
	...
	public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
		...
		if (scrollLoadEnabled) {
			// 设置Footer
			if (null == mFooterLayout) {
				mFooterLayout = new ZRFooterLoadingLayout(getContext());
			}
